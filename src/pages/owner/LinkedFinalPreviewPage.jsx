    ...
    <div className="app-shell">
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-24 space-y-4">
        ...
        <Section title="Contract">
          <Timeline
            items={[
              { label: 'Auditor sent contract', at: contract.sentAt, done: !!contract.sentAt },
              { label: 'You uploaded signed copy', at: contract.signedAt, done: !!contract.signedAt },
              { label: 'Auditor completed onboarding', at: contract.finalSignedAt || property.updatedAt, done: isLive },
