...
// Owner-side mirror of auditor/SectionEditPage. Same UX (photos + notes +
// deep-dive + rooms editor); only the API base differs.
    ...
    for (const room of rooms) {
      ...
      for (const catKey of Object.keys(pendingMap)) {
        ...
        for (const file of files) {
          ...
          const r = await api.post(`/owner/self-properties/${id}/upload-one`, fd, {
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-24">
        ...
        <p className="mt-2 rounded-lg bg-rose-50 px-3 py-2 text-xs font-semibold text-rose-700">
          {isRooms
            ...
            : `Notes required + minimum ${minPhotos} uploaded photos. Follow the field-wise capture instructions below.`}
        </p>
